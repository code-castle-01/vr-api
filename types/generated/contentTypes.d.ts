...
export interface ApiAgendaItemAgendaItem extends Schema.CollectionType {
  ...
  attributes: {
    ...
    requiresSpecialMajority: Attribute.Boolean & Attribute.DefaultTo<false>;
    ...
    > &
      Attribute.Private;
    vote_options: Attribute.Relation<
      'api::agenda-item.agenda-item',
      'oneToMany',
      'api::vote-option.vote-option'
    >;
  };
}

export interface ApiAssemblyAssembly extends Schema.CollectionType {
  collectionName: 'assemblies';
  info: {
    description: 'Asambleas de copropietarios';
    displayName: 'Assembly';
    pluralName: 'assemblies';
    singularName: 'assembly';
  };
  options: {
    draftAndPublish: false;
  };
  attributes: {
    agenda_items: Attribute.Relation<
      'api::assembly.assembly',
      'oneToMany',
      'api::agenda-item.agenda-item'
    >;
...
export interface ApiBlogPostBlogPost extends Schema.CollectionType {
  ...
  attributes: {
    ...
    > &
      Attribute.Private;
    status: Attribute.Enumeration<['draft', 'published', 'rejected']> &
...
export interface ApiVoteOptionVoteOption extends Schema.CollectionType {
  ...
  info: {
    description: 'Opciones de votaci\u00F3n';
    displayName: 'Vote Option';
    pluralName: 'vote-options';
    singularName: 'vote-option';
  };
  options: {
    draftAndPublish: false;
  };
...
export interface ApiVoteVote extends Schema.CollectionType {
  ...
  attributes: {
    ...
    createdBy: Attribute.Relation<'api::vote.vote', 'oneToOne', 'admin::user'> &
      Attribute.Private;
    mechanism: Attribute.Enumeration<
      ['electronic', 'in_person', 'proxy', 'correspondence']
    > &
      Attribute.Required &
      Attribute.DefaultTo<'electronic'>;
    updatedAt: Attribute.DateTime;
    ...
    user: Attribute.Relation<
      ...
      'plugin::users-permissions.user'
    >;
    vote_option: Attribute.Relation<
      'api::vote.vote',
      'manyToOne',
      'api::vote-option.vote-option'
    >;
...
declare module '@strapi/types' {
  export module Shared {
    export interface ContentTypes {
      ...
      'api::assembly.assembly': ApiAssemblyAssembly;
