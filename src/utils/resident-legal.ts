...
const RESIDENT_ACCESS_LEGAL_SEED: ResidentLegalDocumentSeed = {
  ...
  title:
    "Politica de Tratamiento de Datos Personales y Terminos del Portal de Asamblea",
  checkboxLabel:
  ...
  sections: [
    ...
    },
    {
      ...
      paragraphs: [
        "El portal puede tratar datos de identificacion y relacion con la copropiedad, tales como nombre completo, unidad privada, estado de acceso al sistema y coeficiente de copropiedad.",
